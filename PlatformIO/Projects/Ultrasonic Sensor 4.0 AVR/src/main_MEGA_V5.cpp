...
#define maxloops 35000                        //Proper value needs to be tested
...
{ 
  ...
  {  
    ...
    UCSR0B |= _BV(UDRIE0);
    TIFR4 |= _BV(ICF4);                                 //Clear flag since capture event was already triggered by transmitter
    ...
    USART_Transmit_String(" m pulse length: ");
