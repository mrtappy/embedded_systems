...
//Library for rumble engine control

#include <MeasureStates.h>
//Library for distance measurement and evaluation
...
// basic definitions for the state machines

#define SystemCycleTime 10
StateMachine SystemAutomat(smSystemInit, SystemCycle, SystemCycleTime);

#define MeasureCycleTime    10
StateMachine MeasureAutomat(MeasureInit, MeasureCycle, MeasureCycleTime);

lcDateTime  dt;             // Time-Structure of LoopCheck


#define RumbleCycleTime 10
StateMachine RumbleAutomat(RumbleInit, 0, RumbleCycleTime);
...
void setup()
{
  ...
  MotorControl.setup(168000, PWM0, PWM1, PWM2, PWM3);
