//Backup of latest version (12/04/19 10:37 PM)
//In this version the inclusion and exclusion of a third system is working,
//But bound to specific conditions
//Some jumps between states still cause errors.
